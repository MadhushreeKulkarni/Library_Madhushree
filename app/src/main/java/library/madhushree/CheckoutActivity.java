...
import library.madhushree.util.Pair;
import library.madhushree.view.ChartGenerator;
...
public class CheckoutActivity extends Activity implements OnClickListener
{
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.checkout_btn) {
            ...
            Intent intent = new Intent(this, MadhushreeActivity.class);
